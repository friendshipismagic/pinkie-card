...
Quand on clique sur un article, un écran modal s'ouvre et affiche des détails sur l'article et permet de préciser quelques éléments (par exemple la cuisson pour une viande) avant de l'ajouter à la commande.

\includegraphics[width=13cm]{in_place_screen2.jpg}

\item L'écran après avoir choisi "à emporter" :

Sur cet écran l'interface est plus sommaire et les articles sont présentés dans une liste hiérarchisée en sous-catégories. Le système d'écran modal du mode "sur place" est aussi présent.
...
Après la validation de la commande un écran de remerciement est affiché. On donne une estimation du temps d'attente avant le service, est un champ pour afficher des informations quelconques est présent.
